...
<form class="form-control" method="post" action="{{ route('vendas.store') }}">
    @csrf
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
            <div class="mb-3">
                ...
                <input type="text" readonly class="form-control @error('venda')  is-invalid @enderror" id="venda" name="venda" value="{{ $maxVenda }}" placeholder="Nome">
                @if($errors->has('venda'))
